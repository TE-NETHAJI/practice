...
public class employees implements Cloneable {
	 ...
	 * ", enme=" + enme + ", salary=" + salary + ", role=" + role + ", hashcode()="
	 * + hashCode() + ", getEnme()=" + getEnme() + ", getSalary()=" + getSalary() +
	 * ", getRole()=" + getRole() + ", getClass()=" + getClass() + ", hashCode()=" +
